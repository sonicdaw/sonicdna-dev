...
<?php echo op_link_to_member($options->list[$j], array('link_target' => op_image_tag_sf_image($options->list[$j]->getImageFileName(), array('size' => '136x50')))) ?>
<?php else: ?>
<?php echo link_to(op_image_tag_sf_image($options->list[$j]->getImageFileName(), array('size' => '136x50')), $options->link_to.$options->list[$j]->getId()) ?>
<?php endif; ?>
<?php endif; ?></td>
<?php endfor; ?>
</tr>

...
<head>
<?php $current_routing = sfContext::getInstance()->getRouting()->getCurrentRouteName() ?>
...
<?php if (('event_home_artists_frame' !== $current_routing) && ('event_timetable_frame' !== $current_routing)): ?>

<div class="row">
  <div class="gadget_header span12"><?php echo __('Quit "%1%"', array('%1%' => $band->getName())) ?></div>
</div>
...
<div class="row">
  ...
  <div class="span12 center"><?php echo __('Do you really quit the following %band%?') ?></div>

...
abstract class opApplicationConfiguration extends sfApplicationConfiguration
{
  ...
  public static function getCoreConfirmList(sfEvent $event)
  {
    $list = array(
      ...
      'band_confirm'           => array('BandMemberTable', 'joinConfirmList'),
      'band_admin_request'     => array('BandTable', 'adminConfirmList'),
      'band_sub_admin_request' => array('BandTable', 'subAdminConfirmList'),
      'event_confirm'           => array('EventMemberTable', 'joinConfirmList'),
      'event_admin_request'     => array('EventTable', 'adminConfirmList'),
      'event_sub_admin_request' => array('EventTable', 'subAdminConfirmList'),
    );
  ...
  public static function processCoreConfirm(sfEvent $event)
  {
    $list = array(
      ...
      'band_confirm'           => array('BandMemberTable', 'processJoinConfirm'),
      'band_admin_request'     => array('BandTable', 'processAdminConfirm'),
      'band_sub_admin_request' => array('BandTable', 'processSubAdminConfirm'),
      'event_confirm'           => array('EventMemberTable', 'processJoinConfirm'),
      'event_admin_request'     => array('EventTable', 'processAdminConfirm'),
      'event_sub_admin_request' => array('EventTable', 'processSubAdminConfirm'),
    );
  ...
  protected function setConfigHandlers()
  {
   ...
   // sonicdna
    $this->getConfigCache()->registerConfigHandler('../../plugins/opBandPlugin/lib/config/config/band_config.yml', 'opConfigConfigHandler', array('prefix'=>'openpne_band_'));
    include($this->getConfigCache()->checkConfig('../../plugins/opBandPlugin/lib/config/config/band_config.yml'));

    $this->getConfigCache()->registerConfigHandler('../../plugins/opEventPlugin/lib/config/config/event_config.yml', 'opConfigConfigHandler', array('prefix'=> 'openpne_event_'));
    include($this->getConfigCache()->checkConfig('../../plugins/opEventPlugin/lib/config/config/event_config.yml'));
  }
